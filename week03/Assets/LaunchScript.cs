...
public class LaunchScript : MonoBehaviour
{
	...
	{
		//Check to see if the trigger we collided with is the "InvisibleCube"
		//that is in the middle of the Ring gameObject.
		if (other.gameObject.name == "InvisibleCube")
		{
		...
		if (other.gameObject.name == "InvisibleRespawnCube")
		{
			...
			playerWon = false; // stop drawing "You win!" in OnGUI function
		}
	}
